...
uint256 hashGenesisBlock("0x000000008b8f01372e94b223510ef6578a8be5529192853c2b28322cf6bb884c");
...
const string strMessageMagic = "MobiusCoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000008b8f01372e94b223510ef6578a8be5529192853c2b28322cf6bb884c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1408829075;
        block.nBits    = 486604799;
        block.nNonce   = 3470356538;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MobiusCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MobiusCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("MobiusCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running MobiusCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("MobiusCoinMiner terminated\n");
        throw;
    }
}
